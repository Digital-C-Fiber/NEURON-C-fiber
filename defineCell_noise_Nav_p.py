...
def insertChannels(axon,condFactor, gPump=-0.0047891, gNav17=0.10664, gNav18=0.24271, gNav19=9.4779e-05, gKs=0.0069733, gKf=0.012756, gH=0.0025377, gKdr=0.018002, gKna=0.00042):
    ...
    for seg in axon:
        ...
        seg.nattxs_noise1000p.gbar = gNav17*condFactor
...
def setTemp(axon, tempCelsius):
    for seg in axon:
        ...
        seg.nattxs_noise1000p.celsiusT = tempCelsius
...
def balance(axon, Vrest):
    inaSum = -(axon.ina_nattxs_noise1000p + axon.ina_nav1p9_noise1000+axon.ina_nav1p8_noise1000 + axon.ina_h+axon.ina_nakpump)
