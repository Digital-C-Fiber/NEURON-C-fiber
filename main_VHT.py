...
def run(prot=1, path="Results", scalingFactor=1,  dt=0, previousStim=False, tempBranch=32, tempParent=37, 
        gPump=-0.00858942324175466, gNav17=0.029742297138059308, gNav17Parent=0.059484594276118616, gNav18=0.7813520669995635, gNav18Parent=0.4738723337758157, gNav19=2.0556098191680574e-05, 
        gKs=0.011778454843702381, gKf=0.02, gH=0.009118507747098268, gKdr=0.001, gKna=0.003513649995404502,vRest=-56.55982576354996,
